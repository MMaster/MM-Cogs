...
from mmaiuser.common.constants import VISION_SUPPORTED_MODELS
...
class ImageScanSettings(MixinMeta):
    ...
    async def imagescan(self, _):
        """ Change the image scan setting
            ...
            Go [here](https://github.com/zhaobenny/bz-cogs/tree/main/mmaiuser#image-scanning-%EF%B8%8F) for more info.

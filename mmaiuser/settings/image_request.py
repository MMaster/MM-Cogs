...
class ImageRequestSettings(MixinMeta):
    ...
    async def imagerequest(self, _):
        ...
        See [here](https://github.com/zhaobenny/bz-cogs/tree/main/mmaiuser#image-requests-%EF%B8%8F)
    ...
    async def image_request_parameters(self, ctx: commands.Context, *, json_block: str):
        ...
        Example command:
        `[p]mmaiuser imagerequest parameters ```{"sampler_name": "Euler a", "steps": 20}``` `
        """

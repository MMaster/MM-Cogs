...
from mmaiuser.common.constants import URL_PATTERN
from mmaiuser.common.utilities import contains_youtube_link
from mmaiuser.functions.scrape.tool_call import ScrapeToolCall
from mmaiuser.messages_list.converter.embed.youtube import format_youtube_embed

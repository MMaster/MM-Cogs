...
from mmaiuser.messages_list.converter.helpers import format_text_content
from mmaiuser.messages_list.converter.image.AI_horde import \
...
async def process_image(cog: MixinMeta, message: Message, image: Image, mode: ScanImageMode):
    if mode == ScanImageMode.AI_HORDE:
        ...
        try:
            from mmaiuser.messages_list.converter.image.local import \
